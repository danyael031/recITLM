...
//VisualButton botoncito = VisualButton();
//VisualReloj reloj = VisualReloj();

VisualButton botoncito = VisualButton(25,120,"HOLA MUNDO!!!",&pantalla);
VisualReloj reloj = VisualReloj(13,0,&pantalla,&relojRTC);
